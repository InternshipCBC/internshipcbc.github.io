...
const AI_SYSTEM = [
  ...
  "Extract when present, reading the EMAIL BODY, the CV and the COVER LETTER text: track (internship|associate), month, year (4-digit), preferredMode (offline|online),",
  "  yearOfStudy (e.g. '3rd Year' or 'Graduated'), program ('5yr'|'3yr'), college, city, phone. Leave a field empty ONLY if it is genuinely not stated \u2014 do not guess.",
